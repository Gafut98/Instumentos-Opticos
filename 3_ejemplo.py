...
ax2.set_title("Magnitud de la imagen de entrada")
ax2.imshow(magnitudFFT_1, cmap='gray')
#apagar ejes
ax2.axis('off')


ax4.set_title("Imagen con frecuencias espaciales filtradas")
ax4.imshow(np.abs(imagen_final), cmap='gray')
#apagar ejes
ax4.axis('off')

ax3.set_title("Magnitud del producto")
